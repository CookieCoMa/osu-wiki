...
사용의 **문제**가 있는 경우 **[문제해결](#문제해결)** 섹션을 읽거나, **[이 스레드](https://osu.ppy.sh/forum/t/327120)**에 게시 할 수 있습니다. 
...
osu! tourney를 사용하려면 [토너먼트 스텝](https://osu.ppy.sh/g/26)에 일원이 되어야 합니다. 토너먼트 스텝이 되지 않으면 **osu!tourney**에 접속할 수 없습니다.
...
엑세스 권한이 부여되면, [토너먼트 스텝](https://osu.ppy.sh/g/26)에 추가됩니다. 
...
**[다운로드 template.psd 여기](http://osu.ppy.sh/images/tournament/template.zip)** 를 통해 개인 스킨을 간편하게 생성할 수 있습니다.
...
**[이 스레드](https://osu.ppy.sh/forum/t/327120)**에 게시하십시오. 
